...
| Analysis | Swift + Accelerate | Native summary plus portable key service; structure planned | Shared C ABI summary/key path; native Windows execution pending | C# summary/waveform/key call surface built; native Windows execution pending | Native summary/key API builds in the AAR; Kotlin facade wrapping remains pending | Synthetic 120 BPM summary, waveform, rooted A-minor key, real Ogg/FLAC summary, and sidecar gates pass | CP3 / CP-WIN |
