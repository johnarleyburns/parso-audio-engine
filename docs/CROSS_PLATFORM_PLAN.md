...
and exposes create/destroy/play/pause, mixer control, typed transport/loop commands, copied engine
stats, and bounded event polling over the public C ABI. `ParsoEngine` adds the source-level
