...
build_android_gradle() {
    ...
    [ -f "$producer_project/build/maven-repository/com/parsoaudio/parso-audio-android/1.2.0/parso-audio-android-1.2.0.pom" ] || \
        die "Android local Maven publication did not produce its POM"
    [ -f "$producer_project/build/maven-repository/com/parsoaudio/parso-audio-android/1.2.0/parso-audio-android-1.2.0.aar" ] || \
