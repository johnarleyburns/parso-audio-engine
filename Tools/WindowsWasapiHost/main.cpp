...
// The Windows SDK declares these GUIDs in the WASAPI headers, but some MSVC
// installations do not provide their definitions through uuid.lib. This
// host is the single definition unit for the five identifiers it uses.
#if defined(_MSC_VER)
