...
This module packages the checked-in Kotlin `ParsoEngine`, `ParsoAnalysis`, and `ParsoVorbis` facades together with the
...
capture, route changes, Vorbis runtime fixture parity, and JVM lifetime instrumentation remain separate acceptance gates.
